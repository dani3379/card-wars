...
const CARD_POOL: Dictionary = {
	...
	"mana_sprite": {"id": "mana_sprite", "name": "Mana Sprite", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		"rarity": "common", "keywords": [], "desc": "When played: gain 1 mana this turn.",
	...
	"witch": {"id": "witch", "name": "Witch", "type": "creature", "cost": 2, "atk": 2, "hp": 4,
		"rarity": "uncommon", "keywords": [], "desc": "When played: gain 1 mana.",
		"on_play": {"type": "gain_mana", "value": 1}},
	...
	"iron_bastion": {"id": "iron_bastion", "name": "Iron Bastion", "type": "creature", "cost": 3, "atk": 1, "hp": 7,
		"rarity": "uncommon", "keywords": ["armored"], "desc": "Armored. Enemy face damage is reduced by 1.",
		"passive": "reduce_face_damage"},
	"leyline_conduit": {"id": "leyline_conduit", "name": "Leyline Conduit", "type": "creature", "cost": 2, "atk": 0, "hp": 4,
		"rarity": "uncommon", "keywords": [], "desc": "Gain +1 mana at the start of each of your turns.",
	...
	"paladin": {"id": "paladin", "name": "Paladin", "type": "creature", "cost": 3, "atk": 2, "hp": 4,
		"rarity": "uncommon", "keywords": ["last_stand", "adj_buff"], "desc": "Last Stand. Adjacent friendlies +1 ATK.",
		"adj_buff": {"atk": 1, "hp": 0}},
	...
	"chaos_imp": {"id": "chaos_imp", "name": "Chaos Imp", "type": "creature", "cost": 1, "atk": 1, "hp": 2,
		"rarity": "uncommon", "keywords": ["on_enter"], "desc": "On-Enter: cast a random spell at no mana cost (auto-targeted).",
	...
	"doom_knight": {"id": "doom_knight", "name": "Doom Knight", "type": "creature", "cost": 4, "atk": 3, "hp": 5,
		"rarity": "rare", "keywords": ["piercing", "swift"], "desc": "Swift. Piercing."},
...
const UPGRADES: Dictionary = {
	...
	"mana_sprite":    {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "When played: gain 2 mana this turn."},
	...
	"iron_bastion":   {"atk": 1, "hp": 2,
		"desc": "Armored. Enemy face damage is reduced by 1."},
	"leyline_conduit": {"atk": 0, "hp": 1, "on_play_value": 1,
		"desc": "Gain +1 mana at the start of each of your turns."},
	...
	"chaos_imp":      {"atk": 1, "hp": 1,
		"desc": "On-Enter: cast a random spell at no mana cost (auto-targeted)."},
