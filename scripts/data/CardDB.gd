...
const CARD_POOL: Dictionary = {
	...
	"ratling": {"id": "ratling", "name": "Ratling", "type": "creature", "cost": 1, "atk": 2, "hp": 2,
		...
		"desc": "Wither 1. On-death: deal 2 to opposing. Floop: deal 1 to opposing, +1 ATK perm.",
	...
	"stone_wall": {"id": "stone_wall", "name": "Stone Wall", "type": "creature", "cost": 2, "atk": 0, "hp": 7,
		"rarity": "common", "keywords": ["thorns", "floop"],
		"desc": "Thorns. Can't attack. Adj empty -1 face dmg. Floop: adj friendlies gain Armored this round.",
