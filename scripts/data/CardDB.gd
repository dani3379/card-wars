...
const CARD_POOL: Dictionary = {
	...
	"crystal_sentry": {"id": "crystal_sentry", "name": "Crystal Sentry", "type": "creature", "cost": 2, "atk": 2, "hp": 2,
		...
		"desc": "Shield — blocks the first hit, then breaks. On-Enter: an adjacent friendly gains Shield.",
	...
	"shieldbearer": {"id": "shieldbearer", "name": "Shieldbearer", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
		"rarity": "common", "keywords": ["armored"], "desc": "Armored — takes 1 less damage from each hit."},
	...
	"hexblade": {"id": "hexblade", "name": "Hexblade", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		...
		"desc": "Ranged. +1 ATK per spell cast this fight.",
		"passive": "atk_per_spell"},
	"harpy": {"id": "harpy", "name": "Harpy", "type": "creature", "cost": 2, "atk": 2, "hp": 2,
		"rarity": "common", "keywords": ["swift"], "desc": "Swift — strikes first, before the enemy hits back. On-Enter: pull the opposing back-row enemy forward and deal 1 damage to it.",
	...
	"raven": {"id": "raven", "name": "Raven", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		"rarity": "common", "keywords": ["ranged"], "desc": "Ranged. On-Enter: deal 2 damage to a random enemy back-row creature.",
	...
	"plague_rat": {"id": "plague_rat", "name": "Plague Rat", "type": "creature", "cost": 1, "atk": 1, "hp": 1,
		...
		"desc": "Poison — any creature it damages dies."},
	"torchbearer": {"id": "torchbearer", "name": "Torchbearer", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		...
		"adj_buff": {"atk": 1, "hp": 0}},
	"gravedigger": {"id": "gravedigger", "name": "Gravedigger", "type": "creature", "cost": 1, "atk": 1, "hp": 2,
	...
	"stone_wall": {"id": "stone_wall", "name": "Stone Wall", "type": "creature", "cost": 1, "atk": 0, "hp": 5,
		...
		"desc": "Thorns — deals 1 damage back to attackers. Can't attack. Reduces face damage from adjacent empty lanes by 1.",
		"passive": "cannot_attack_wall"},
	"mana_sprite": {"id": "mana_sprite", "name": "Errand Sprite", "type": "creature", "cost": 1, "atk": 1, "hp": 2,
		"rarity": "common", "keywords": [], "desc": "On-Enter: gain 1 Command this turn.",
	...
	#  UNCOMMON CREATURES
	# ═══════════════════════════════════════════
	"battle_drummer": {"id": "battle_drummer", "name": "Battle Drummer", "type": "creature", "cost": 2, "atk": 1, "hp": 3,
	...
	"witch": {"id": "witch", "name": "Witch", "type": "creature", "cost": 2, "atk": 2, "hp": 3,
		"rarity": "uncommon", "keywords": [], "desc": "On-Enter: gain 1 Command.",
		"on_play": {"type": "gain_mana", "value": 1}},
	...
	"mule": {"id": "mule", "name": "Mule", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		"rarity": "uncommon", "keywords": [], "desc": "On-Enter: the next card you play this turn costs 1 less.",
	...
	"blood_pyre": {"id": "blood_pyre", "name": "Blood Pyre", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		"rarity": "uncommon", "keywords": [], "desc": "On-Enter: sacrifice this creature. Adjacent friendlies get +2 ATK this fight.",
	...
	"vengeance": {"id": "vengeance", "name": "Vengeance", "type": "creature", "cost": 1, "atk": 1, "hp": 2,
		"rarity": "uncommon", "keywords": [],
	...
	"iron_bastion": {"id": "iron_bastion", "name": "Iron Bastion", "type": "creature", "cost": 3, "atk": 1, "hp": 7,
		...
		"desc": "Armored. Formation — grows +1/+1 each round beside a friendly in its row. Enemy face damage is reduced by 1.",
	...
	"hydra": {"id": "hydra", "name": "Hydra", "type": "creature", "cost": 3, "atk": 3, "hp": 5,
	...
	# ═══════════════════════════════════════════
	"riteforge": {"id": "riteforge", "name": "Riteforge", "type": "creature", "cost": 2, "atk": 0, "hp": 4,
		"rarity": "rare", "keywords": [],
		"desc": "Start of each round: all friendlies get +1 ATK this fight.",
		"passive": "riteforge_ramp"},
	"warchief": {"id": "warchief", "name": "Warchief", "type": "creature", "cost": 4, "atk": 0, "hp": 6,
		"rarity": "rare", "keywords": [],
	...
	"doom_knight": {"id": "doom_knight", "name": "Doom Knight", "type": "creature", "cost": 4, "atk": 3, "hp": 5,
		...
		"desc": "Overrun — +1 ATK this round if the lane across is open. Piercing — overkill carries to the enemy back row, then their face. Swift."},
	...
	"cinder_pup": {"id": "cinder_pup", "name": "Cinder Pup", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		...
		"desc": "Doom 2 — counts down each round; at 0 it hits enemy face for its ATK and dies. Bred to burn."},
	...
	"ash_hound": {"id": "ash_hound", "name": "Ash Hound", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		...
		"desc": "Rampage — each creature it kills gives it +1 ATK for the rest of the fight. It eats well."},
	...
	"bloodsworn": {"id": "bloodsworn", "name": "Bloodsworn", "type": "creature", "cost": 2, "atk": 3, "hp": 3,
		...
		"desc": "Lifelink — when it deals damage, you heal 1 HP. The oath is simple: it bleeds, you don't."},
	...
	"scholar": {"id": "scholar", "name": "Scholar", "type": "creature", "cost": 2, "atk": 2, "hp": 3,
		...
		"desc": "Ranged. On-Enter: Discover a spell.",
...
const UPGRADES: Dictionary = {
	...
	"shieldbearer":   {"atk": 0, "hp": 2,
		"desc": "Armored — takes 1 less damage from each hit."},
	...
	"harpy":          {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Swift — strikes first, before the enemy hits back. On-Enter: pull the opposing back-row enemy forward and deal 2 damage to it."},
	"thornguard":     {"atk": 1, "hp": 2, "on_play_value": 1,
		"desc": "Thorns. On-Death: deal 1 damage to all enemies."},
	"raven":          {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Ranged. On-Enter: deal 3 damage to a random enemy back-row creature."},
	...
	"mana_sprite":    {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "On-Enter: gain 2 Command this turn."},
	...
	"mule":           {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "On-Enter: the next two cards you play this turn cost 1 less."},
	"husk":           {"atk": 1, "hp": 1,
		"desc": "Gains +1/+1 this fight whenever any creature on either side dies."},
	...
	"blood_pyre":     {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "On-Enter: sacrifice this creature. Adjacent friendlies get +3 ATK this fight."},
	"copycat":        {"atk": 1, "hp": 2,
	...
	"doom_knight":    {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Overrun 2 — +2 ATK this round if the lane across is open. Piercing — overkill carries to the enemy back row, then their face. Swift."},
	"inferno":        {"dmg_bonus": 1,
	...
	"cinder_pup":     {"atk": 1, "hp": 1,
		"desc": "Doom 2 — counts down each round; at 0 it hits enemy face for its ATK and dies. Bred to burn, and proud of it."},
	...
	"ash_hound":      {"atk": 1, "hp": 1,
		"desc": "Rampage — each creature it kills gives it +1 ATK for the rest of the fight. The road is full of supper."},
