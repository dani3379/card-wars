...
const CARD_POOL: Dictionary = {
	...
	"troll": {"id": "troll", "name": "Troll", "type": "creature", "cost": 2, "atk": 2, "hp": 4,
	...
	"crystal_sentry": {"id": "crystal_sentry", "name": "Crystal Sentry", "type": "creature", "cost": 2, "atk": 2, "hp": 2,
		...
		"desc": "Shield. On-Enter: an adjacent friendly gains Shield.",
	...
	"shieldbearer": {"id": "shieldbearer", "name": "Shieldbearer", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
	...
	"lookout": {"id": "lookout", "name": "Lookout", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		"rarity": "common", "keywords": ["swift"], "desc": "Swift. Placed in the front row: +1 ATK this fight. Placed in the back row: draw 1.",
	...
	"hexblade": {"id": "hexblade", "name": "Hexblade", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		"rarity": "common", "keywords": ["ranged"],
		"desc": "Sniper. +1 ATK per spell cast this fight.",
		"passive": "atk_per_spell"},
	"harpy": {"id": "harpy", "name": "Harpy", "type": "creature", "cost": 2, "atk": 2, "hp": 2,
		"rarity": "common", "keywords": ["swift"], "desc": "Swift. On-Enter: pull the opposing back-row enemy forward and deal 1 damage to it.",
		"on_play": {"type": "haul_front", "value": 1}},
	...
	"raven": {"id": "raven", "name": "Raven", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		"rarity": "common", "keywords": ["ranged"], "desc": "Sniper. On-Enter: deal 2 damage to a random enemy back-row creature.",
	...
	"scavenger": {"id": "scavenger", "name": "Scavenger", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		"rarity": "common", "keywords": ["swift", "on_enter"], "desc": "Swift. On-Enter: gain 3 gold.",
		"on_enter": {"type": "gain_gold", "value": 3}},
	"stone_wall": {"id": "stone_wall", "name": "Stone Wall", "type": "creature", "cost": 1, "atk": 0, "hp": 6,
		...
		"passive": "cannot_attack_wall"},
	"mana_sprite": {"id": "mana_sprite", "name": "Errand Sprite", "type": "creature", "cost": 1, "atk": 0, "hp": 2,
		"rarity": "common", "keywords": [], "desc": "On-Enter: gain 2 Command this turn.",
		"on_play": {"type": "gain_mana", "value": 2}},
	"tallow_doll": {"id": "tallow_doll", "name": "Tallow Doll", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		"rarity": "common", "keywords": [],
		"desc": "Gets +1/+1 for each other Tallow Doll you've played this fight.",
		"passive": "tallow_stacking"},
	"skirmisher": {"id": "skirmisher", "name": "Skirmisher", "type": "creature", "cost": 2, "atk": 3, "hp": 1,
		"rarity": "common", "keywords": ["swift", "ranged"], "desc": "Swift. Sniper. Hits the back line hard before it can act — but shatters at a touch."},
	"lancer": {"id": "lancer", "name": "Lancer", "type": "creature", "cost": 2, "atk": 2, "hp": 3,
		"rarity": "common", "keywords": ["overrun"], "overrun": 2,
		"desc": "Overrun 2. First over the wall."},
	...
	"shield_wall": {"id": "shield_wall", "name": "Shield Wall", "type": "spell", "cost": 1,
		"rarity": "common", "keywords": [], "desc": "Give a friendly +4 HP. It gains Thorns this round.",
	...
	"patch_up": {"id": "patch_up", "name": "Patch Up", "type": "spell", "cost": 1,
		"rarity": "common", "keywords": [], "desc": "Heal a friendly creature 4 HP and draw 1.",
	...
	"shove": {"id": "shove", "name": "Shove", "type": "spell", "cost": 0,
		"rarity": "common", "keywords": [], "desc": "Deal 2 damage to an enemy creature, shove it to the back row, and reduce its ATK by 1.",
	...
	"blood_tithe": {"id": "blood_tithe", "name": "Blood Tithe", "type": "spell", "cost": 0,
		"rarity": "common", "keywords": [], "desc": "Deal 4 damage to enemy face. Take 1 damage yourself.",
	...
	"quick_shot": {"id": "quick_shot", "name": "Quick Shot", "type": "spell", "cost": 0,
		"rarity": "common", "keywords": [], "desc": "Deal 2 damage to any target. Draw 1.",
		"spell": {"type": "custom", "id": "quick_shot"}, "targeting": "any"},
	"scrap": {"id": "scrap", "name": "Cinders", "type": "spell", "cost": 0,
	...
	"adrenaline": {"id": "adrenaline", "name": "Second Wind", "type": "spell", "cost": 0,
	...
	"battle_drummer": {"id": "battle_drummer", "name": "Battle Drummer", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
		"rarity": "uncommon", "keywords": ["armored", "adj_buff"], "desc": "Armored. Adjacent friendlies +2 ATK.",
		"adj_buff": {"atk": 2, "hp": 0}},
	"witch": {"id": "witch", "name": "Witch", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
		"rarity": "uncommon", "keywords": ["ranged"], "desc": "Sniper. On-Enter: gain 2 Command.",
		"on_play": {"type": "gain_mana", "value": 2}},
	...
	"mule": {"id": "mule", "name": "Mule", "type": "creature", "cost": 1, "atk": 1, "hp": 3,
		"rarity": "uncommon", "keywords": ["summon"], "desc": "Summon. On-Enter: the next card you play this turn costs 1 less.",
		"on_play": {"type": "discount_next", "value": 1}},
	"husk": {"id": "husk", "name": "Husk", "type": "creature", "cost": 2, "atk": 1, "hp": 5,
		"rarity": "uncommon", "keywords": ["guardian"],
		"desc": "Guardian. Gains +1/+1 this fight whenever a friendly creature dies.",
	...
	"carrion_priest": {"id": "carrion_priest", "name": "Carrion Priest", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
		"rarity": "uncommon", "keywords": [], "desc": "Whenever one of your creatures dies, deal 1 damage to enemy face.",
		"passive": "drain_on_ally_death"},
	"gravecaller": {"id": "gravecaller", "name": "Gravecaller", "type": "creature", "cost": 2, "atk": 2, "hp": 2,
		"rarity": "uncommon", "keywords": ["summon", "on_death"], "desc": "Summon. On-Death: summon a 1/1 token in this lane.",
		"on_death": {"type": "summon", "atk": 1, "hp": 1}},
	"breaker": {"id": "breaker", "name": "Breaker", "type": "creature", "cost": 3, "atk": 3, "hp": 4,
		"rarity": "uncommon", "keywords": ["overrun", "piercing"], "overrun": 1, "desc": "Overrun. Piercing. Shove their wall aside and it runs the lane to face."},
	...
	"blood_pyre": {"id": "blood_pyre", "name": "Blood Pyre", "type": "creature", "cost": 1, "atk": 2, "hp": 2,
		"rarity": "uncommon", "keywords": [], "desc": "On-Enter: sacrifice this creature. Adjacent friendlies get +2 ATK this fight, and draw a card.",
		"on_play": {"type": "blood_sacrifice", "value": 2}},
	"copycat": {"id": "copycat", "name": "Changeling", "type": "creature", "cost": 1, "atk": 0, "hp": 1,
	...
	"leyline_conduit": {"id": "leyline_conduit", "name": "Leyline Conduit", "type": "creature", "cost": 2, "atk": 0, "hp": 4,
		"rarity": "uncommon", "keywords": ["on_enter"],
		"desc": "On-Enter: gain 1 Command this turn. Gain +1 Command at the start of each of your turns.",
	...
	"the_glutton": {"id": "the_glutton", "name": "The Glutton", "type": "creature", "cost": 2, "atk": 2, "hp": 3,
		...
		"desc": "Overrun. On-Enter: destroy adjacent friendlies. Gain +2/+2 for each destroyed.",
	...
	"shieldmaiden": {"id": "shieldmaiden", "name": "Shieldmaiden", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
		"rarity": "uncommon", "keywords": ["guardian", "formation"], "formation": 1,
		"desc": "Guardian. Formation."},
	...
	"emberwright": {"id": "emberwright", "name": "Emberwright", "type": "creature", "cost": 2, "atk": 3, "hp": 2,
		"rarity": "uncommon", "keywords": ["ranged"],
		"desc": "Sniper. Whenever you cast a spell, deal 1 damage to enemy face.",
	...
	"assassin": {"id": "assassin", "name": "Assassin", "type": "creature", "cost": 2, "atk": 5, "hp": 1,
		"rarity": "rare", "keywords": ["swift"], "desc": "Swift. Dies at end of round. On-Enter: destroy the opposing creature if its HP is 2 or less.",
		"passive": "dies_end_of_turn",
		"on_play": {"type": "execute", "value": 2}},
	"hydra": {"id": "hydra", "name": "Hydra", "type": "creature", "cost": 3, "atk": 3, "hp": 6,
	...
	"summoner": {"id": "summoner", "name": "Summoner", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
		"rarity": "uncommon", "keywords": ["summon", "guardian"], "desc": "Summon. Guardian."},
	"paladin": {"id": "paladin", "name": "Paladin", "type": "creature", "cost": 3, "atk": 3, "hp": 4,
		"rarity": "uncommon", "keywords": ["last_stand", "adj_buff"],
		"desc": "Last Stand. Adjacent friendlies +1 ATK.",
		"adj_buff": {"atk": 1, "hp": 0}},
	...
	"ironclad_veteran": {"id": "ironclad_veteran", "name": "Ironclad Veteran", "type": "creature", "cost": 3, "atk": 3, "hp": 4,
	...
	"glass_knight": {"id": "glass_knight", "name": "Glass Knight", "type": "creature", "cost": 2, "atk": 3, "hp": 1,
	...
	"soul_swap": {"id": "soul_swap", "name": "Soul Swap", "type": "spell", "cost": 0,
		"rarity": "uncommon", "keywords": [], "desc": "An enemy creature swaps its ATK and HP. Turn a wall into a glass jaw.",
	...
	"holy_smite": {"id": "holy_smite", "name": "Holy Smite", "type": "spell", "cost": 1,
		"rarity": "uncommon", "keywords": [], "desc": "Deal damage to an enemy creature equal to its missing HP, but at least 3.",
	...
	"riteforge": {"id": "riteforge", "name": "Riteforge", "type": "creature", "cost": 2, "atk": 0, "hp": 5,
		...
		"desc": "Formation. Start of each round: all friendlies get +1 ATK this fight.",
		"passive": "riteforge_ramp"},
	"warchief": {"id": "warchief", "name": "Warchief", "type": "creature", "cost": 3, "atk": 2, "hp": 6,
		"rarity": "rare", "keywords": ["formation"], "formation": 1,
		"desc": "Formation. Start of each round: ATK becomes 2 + the number of your other creatures.",
		"passive": "warchief_aura"},
	"doom_knight": {"id": "doom_knight", "name": "Doom Knight", "type": "creature", "cost": 4, "atk": 5, "hp": 4,
		"rarity": "rare", "keywords": ["piercing", "swift", "doom"], "doom": 2,
		"desc": "Swift. Piercing. Doom 2."},
	...
	"overwhelming_force": {"id": "overwhelming_force", "name": "Overwhelming Force", "type": "spell", "cost": 3,
	...
	"ash_hound": {"id": "ash_hound", "name": "Ash Hound", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		...
		"desc": "Rampage. It eats well."},
	"ember_stalker": {"id": "ember_stalker", "name": "Ember Stalker", "type": "creature", "cost": 3, "atk": 3, "hp": 3,
	...
	"cinder_acolyte": {"id": "cinder_acolyte", "name": "Cinder Acolyte", "type": "creature", "cost": 2, "atk": 2, "hp": 3,
		...
		"desc": "Sniper. Lifelink. It tends the censer and skims a little warmth off the top."},
	"ember_warden": {"id": "ember_warden", "name": "Ember Warden", "type": "creature", "cost": 2, "atk": 1, "hp": 4,
		"rarity": "uncommon", "keywords": [],
		"desc": "Whenever one of your creatures detonates, this gains +2 ATK this fight.",
		"passive": "feeds_on_doom"},
	# ─── Pyre spells ──────────────────────────────────────────────────────
	...
	"scholar": {"id": "scholar", "name": "Scholar", "type": "creature", "cost": 2, "atk": 2, "hp": 3,
		"rarity": "uncommon", "keywords": ["ranged", "on_enter"],
		"desc": "Sniper. On-Enter: Discover a spell.",
...
const UPGRADES: Dictionary = {
	...
	"lookout":        {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Swift. Placed in the front row: +2 ATK this fight. Placed in the back row: draw 1."},
	"warding_stone":  {"atk": 0, "hp": 2, "on_play_value": 1,
		"desc": "Guardian. Thorns. Adjacent enemies must attack this."},
	"hexblade":       {"atk": 1, "hp": 1,
		"desc": "Sniper. +1 ATK per spell cast this fight."},
	"harpy":          {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Swift. On-Enter: pull the opposing back-row enemy forward and deal 2 damage to it."},
	"thornguard":     {"atk": 1, "hp": 2, "on_play_value": 1,
		"desc": "Thorns. On-Death: deal 1 damage to all enemies."},
	"raven":          {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Sniper. On-Enter: deal 3 damage to a random enemy back-row creature."},
	...
	"scavenger":      {"atk": 1, "hp": 1, "on_enter_value": 3, "on_play_value": 1,
		"desc": "Swift. On-Enter: gain 6 gold."},
	"stone_wall":     {"atk": 0, "hp": 3,
		"desc": "Thorns. Can't attack. Reduces face damage from adjacent empty lanes by 1."},
	"mana_sprite":    {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "On-Enter: gain 3 Command this turn."},
	"tallow_doll":    {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Gets +1/+1 for each other Tallow Doll you've played this fight."},
	"skirmisher":     {"atk": 1, "hp": 1,
		"desc": "Swift. Sniper. Strikes the back line before it can act."},
	"lancer":         {"atk": 1, "hp": 1,
		"desc": "Overrun 2. First over the wall."},
	...
	"shield_wall":    {"dmg_bonus": 2,  # bumps the bandage value via resolver
		"desc": "Give a friendly +6 HP. It gains Thorns this round."},
	"war_cry":        {"dmg_bonus": 1,
	...
	"patch_up":       {"dmg_bonus": 2, "extra_draw": 1,
		"desc": "Heal a friendly creature 6 HP and draw 2."},
	...
	"shove":          {"dmg_bonus": 1, "extra_mana": 1,  # "extra_mana" repurposed: extra ATK debuff
		"desc": "Deal 3 damage to an enemy creature, shove it to the back row, and reduce its ATK by 2."},
	"gambit":         {"add_keywords": ["retain"],
		"desc": "Discard up to 3 cards, then draw that many. Retain."},
	"blood_tithe":    {"dmg_bonus": 2,
		"desc": "Deal 6 damage to enemy face. Take 1 damage yourself."},
	...
	"quick_shot":     {"dmg_bonus": 1, "extra_draw": 1,
		"desc": "Deal 3 damage to any target. Draw 2."},
	"scrap":          {"extra_mana": 1,
	...
	"battle_drummer": {"atk": 1, "hp": 1, "adj_buff_atk": 1,
		"desc": "Armored. Adjacent friendlies +3 ATK."},
	"witch":          {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Sniper. On-Enter: gain 3 Command."},
	...
	"mule":           {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Summon. On-Enter: the next two cards you play this turn cost 1 less."},
	"husk":           {"atk": 1, "hp": 1,
		"desc": "Guardian. Gains +1/+1 this fight whenever a friendly creature dies."},
	...
	"carrion_priest": {"atk": 1, "hp": 1,
		"desc": "Whenever one of your creatures dies, deal 2 damage to enemy face."},
	"gravecaller":    {"atk": 1, "hp": 1, "on_death_atk": 1, "on_death_hp": 1,
		"desc": "Summon. On-Death: summon a 2/2 token in this lane."},
	"breaker":        {"atk": 1, "hp": 1,
		"desc": "Overrun. Piercing. Shove their wall aside and it runs the lane to face."},
	"cleave_hound":   {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "When this attacks: also deals 1 damage to adjacent opposing creatures."},
	"blood_pyre":     {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "On-Enter: sacrifice this creature. Adjacent friendlies get +3 ATK this fight, and draw a card."},
	"copycat":        {"atk": 1, "hp": 2,
	...
	"leyline_conduit": {"atk": 0, "hp": 1, "on_play_value": 1,
		"desc": "On-Enter: gain 2 Command this turn. Gain +1 Command at the start of each of your turns."},
	...
	"emberwright":    {"atk": 1, "hp": 1,
		"desc": "Sniper. Whenever you cast a spell, deal 2 damage to enemy face."},
	"summoner":       {"atk": 1, "hp": 1, "on_play_atk": 1, "on_play_hp": 1,
		"desc": "Summon. Guardian."},
	...
	"hoarfrost":      {"cost": -1,
		"desc": "Target friendly gains Shield. The opposing enemy can't attack this round."},
	"holy_smite":     {"cost": -1,
		"desc": "Deal damage to an enemy creature equal to its missing HP, but at least 3."},
	...
	"assassin":       {"atk": 1, "hp": 0, "on_play_value": 1,
		"desc": "Swift. Dies at end of round. On-Enter: destroy the opposing creature if its HP is 3 or less."},
	"hydra":          {"atk": 1, "hp": 1,
	...
	# ─── 4-cost powerhouses ───────────────────────────────────────────────
	"riteforge":      {"hp": 2,
		"desc": "Formation. Start of each round: all friendlies get +2 ATK this fight."},
	"warchief":       {"atk": 1, "hp": 1,
		"desc": "Formation. Start of each round: ATK becomes 3 + the number of your other creatures."},
	"doom_knight":    {"atk": 1, "hp": 2,
		"desc": "Swift. Piercing. Doom 2."},
	"inferno":        {"dmg_bonus": 1,
	...
	"ash_hound":      {"atk": 1, "hp": 1,
		"desc": "Rampage. The road is full of supper."},
	...
	"ember_warden":   {"atk": 1, "hp": 1,
		"desc": "Whenever one of your creatures detonates, this gains +3 ATK this fight."},
