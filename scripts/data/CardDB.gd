...
const CARD_POOL: Dictionary = {
	...
	"pikeman": {"id": "pikeman", "name": "Pikeman", "type": "creature", "cost": 2, "atk": 2, "hp": 3,
		"rarity": "common", "keywords": [], "desc": "When played: shove the opposing creature into its back row. If it can't move, deal 2 damage to it instead.",
		"on_play": {"type": "shove_back", "value": 2}},
	"lookout": {"id": "lookout", "name": "Lookout", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		"rarity": "common", "keywords": ["swift"], "desc": "Swift. Vanguard: placed in the front row, +1 ATK this fight; placed in the back row, draw a card.",
	...
	"harpy": {"id": "harpy", "name": "Harpy", "type": "creature", "cost": 2, "atk": 2, "hp": 2,
		"rarity": "common", "keywords": ["swift"], "desc": "Swift. When played: drag the opposing back-row enemy to the front and deal 1 damage to it.",
	...
	"raven": {"id": "raven", "name": "Raven", "type": "creature", "cost": 1, "atk": 2, "hp": 1,
		"rarity": "common", "keywords": ["ranged"], "desc": "Ranged. When played: deal 2 damage to a random enemy back-row creature.",
	...
	# ═══════════════════════════════════════════
	"riteforge": {"id": "riteforge", "name": "Riteforge", "type": "creature", "cost": 4, "atk": 0, "hp": 6,
	...
	"curse": {"id": "curse", "name": "Curse", "type": "spell", "cost": 0,
		"rarity": "starter", "keywords": [], "desc": "Misfortune, dealt into your hand. Does nothing.",
		"spell": {"type": "none"}, "targeting": "none"},
	"wound": {"id": "wound", "name": "Wound", "type": "spell", "cost": 0,
		"rarity": "starter", "keywords": ["retain"],
		"desc": "Retain. It festers in your hand and does nothing.",
		"spell": {"type": "none"}, "targeting": "none"},
}
...
const UPGRADES: Dictionary = {
	...
	"pikeman":        {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "When played: shove the opposing creature into its back row. If it can't move, deal 3 damage to it instead."},
	"lookout":        {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Swift. Vanguard: front row +2 ATK this fight; back row, draw a card."},
	"warding_stone":  {"atk": 0, "hp": 2, "on_play_value": 1,
		"desc": "Guardian. Thorns. Adjacent enemies must attack this."},
	"hexblade":       {"atk": 1, "hp": 1,
		"desc": "Ranged. +1 ATK per spell cast this fight."},
	"harpy":          {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Swift. When played: drag the opposing back-row enemy to the front and deal 2 damage to it."},
	"thornguard":     {"atk": 1, "hp": 2, "on_play_value": 1,
		"desc": "Thorns. On-Death: deal 1 damage to all enemies."},
	"raven":          {"atk": 1, "hp": 1, "on_play_value": 1,
		"desc": "Ranged. When played: deal 3 damage to a random enemy back-row creature."},
