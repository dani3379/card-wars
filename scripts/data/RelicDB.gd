...
## Tiers: starting (8), combat (~80, includes 4 class-restricted), utility (8), boss (18).
## Total 122 relics after the 3-round design pass (StS + Hades + Monster Train + Balatro + Wildfrost + Cobalt Core + Inscryption + Backpack Hero + AtO imports).
...
const RELICS: Dictionary = {
	...
	"iron_buckler": {"id": "iron_buckler", "name": "Iron Buckler", "tier": "starting",
		"desc": "First creature you play each fight gains Last Stand.",
	...
	"banner_of_unity": {"id": "banner_of_unity", "name": "Banner of Unity", "tier": "combat",
		"desc": "Your adjacency buffs grant +1 extra ATK.",
	...
	"battle_scars": {"id": "battle_scars", "name": "Battle Scars", "tier": "combat",
		"desc": "First time you take face damage each fight: gain 2 mana this turn.",
	...
	"resonance_crystal": {"id": "resonance_crystal", "name": "Resonance Crystal", "tier": "combat",
		"desc": "First time a friendly creature with a keyword dies each fight: all your other creatures gain that keyword.",
	...
	"rear_guard_charm": {"id": "rear_guard_charm", "name": "Rear Guard Charm", "tier": "combat",
		"desc": "When a front-row friendly dies: the back-row creature in its column gets +1/+1 this combat.",
	...
	"whetstone": {"id": "whetstone", "name": "Whetstone", "tier": "utility",
		"desc": "Once per act, Reforge at a rest site: upgrade TWO cards instead of one.",
	...
	"mana_tide": {"id": "mana_tide", "name": "Mana Tide", "tier": "combat",
		"desc": "After you bank mana: the next creature you play costs 1 less.",
	...
	"toolbox": {"id": "toolbox", "name": "Toolbox", "tier": "combat",
		"desc": "Start each combat: choose 1 of 3 extra cards to add to hand.",
		"hooks": ["combat_start"], "effect": "toolbox", "value": 3},
	"bottled_talisman": {"id": "bottled_talisman", "name": "Bottled Talisman", "tier": "combat",
		"desc": "Choose a card in your deck. Always start combat with it in hand.",
	...
	"mana_drunkard": {"id": "mana_drunkard", "name": "Mana Drunkard", "tier": "combat",
		"desc": "If you spend all mana 2 turns in a row: +1 max mana this fight.",
	...
	"skull_throne": {"id": "skull_throne", "name": "Skull Throne", "tier": "combat",
		"desc": "When 5 friendlies die in one round: +2 max mana this fight.",
		"hooks": ["creature_death"], "effect": "skull_throne", "value": 2},
	"reapers_scythe": {"id": "reapers_scythe", "name": "Reaper's Scythe", "tier": "combat",
		"desc": "When you sacrifice a creature with a floop: replace the next-played creature's floop with it (or grant if none).",
	...
	"soul_ledger": {"id": "soul_ledger", "name": "Soul Ledger", "tier": "combat",
		"desc": "Every 5th friendly death (across all combats): summon a 4/4 token in a random empty lane.",
		"hooks": ["creature_death"], "effect": "soul_ledger", "value": 5},

	# ─── Spell deepening ───
	"reagent_pouch": {"id": "reagent_pouch", "name": "Reagent Pouch", "tier": "combat",
		"desc": "First spell of each combat is Sharpened (+2 spell damage).",
	...
	"mana_pearl": {"id": "mana_pearl", "name": "Mana Pearl", "tier": "combat",
	...
	"wormwood": {"id": "wormwood", "name": "Wormwood", "tier": "combat",
		"desc": "When a friendly takes damage: it gains +1 ATK permanently (max +5 per creature per combat).",
	...
	"stygian_soul": {"id": "stygian_soul", "name": "Stygian Soul", "tier": "combat",
		"desc": "When an enemy dies: heal 1 HP. Max 5 per combat.",
		"hooks": ["enemy_death"], "effect": "heal_on_kill", "value": 5},
	"bone_hourglass": {"id": "bone_hourglass", "name": "Bone Hourglass", "tier": "combat",
		"desc": "Each act, pick: +1 ATK in front row / +1 HP in back row / +1 max mana when center lanes are full.",
	...
	"blueprint": {"id": "blueprint", "name": "Blueprint", "tier": "combat",
		"desc": "Next creature you play copies the on-enter effect of the previous creature played this combat.",
		"hooks": ["creature_played"], "effect": "blueprint", "value": 0},
	"brainstorm": {"id": "brainstorm", "name": "Brainstorm", "tier": "combat",
		"desc": "Each round, the first creature you play copies the keywords of the first creature played this combat.",
		"hooks": ["creature_played"], "effect": "brainstorm", "value": 0},
	"mime": {"id": "mime", "name": "Mime", "tier": "combat",
		"desc": "At end of turn, ONE chosen card in hand triggers its floop without paying the cost.",
	...
	"frost_spike": {"id": "frost_spike", "name": "Frost Spike", "tier": "combat",
		"desc": "First creature you play each combat applies Wither 1 when it attacks.",
		"hooks": ["creature_played"], "effect": "frost_spike", "value": 1},
	"junk_slot": {"id": "junk_slot", "name": "Junk Slot", "tier": "combat",
		"desc": "If you have 4+ empty board slots: +1 max mana.",
	...
	"death_card": {"id": "death_card", "name": "Death Card", "tier": "combat",
		"desc": "Friendlies that die this combat go to hand instead of discard. Costs +1 each time they return this combat.",
	...
	"diagonal_crest": {"id": "diagonal_crest", "name": "Diagonal Crest", "tier": "combat",
		"desc": "Diagonal friendlies count as adjacent. Your adjacency buffs grant +1 extra HP.",
	...
	"raiders_oath": {"id": "raiders_oath", "name": "Raider's Oath", "tier": "combat",
		"desc": "Raider only. When you play a creature with Swift: gain 1 mana this turn.",
	...
	"stalwarts_anvil": {"id": "stalwarts_anvil", "name": "Stalwart's Anvil", "tier": "combat",
		"desc": "Stalwart only. First time a friendly takes damage each turn: gain 1 mana this turn.",
	...
	"pyromancers_scar": {"id": "pyromancers_scar", "name": "Pyromancer's Scar", "tier": "combat",
		"desc": "Pyromancer only. First spell each combat is Doubled (cast twice on the same target).",
